				...
				<div class="min-height-200px">
					...
					<div class="pd-20 card-box mb-30">
						<div class="clearfix mb-20">
							<p>
								Cordial saludo <?php echo $_SESSION['session']['userData']['firstName'].' '.$_SESSION['session']['userData']['lastName'] ?> , a continuación podrá ver el horario relacionado para el presente semestre.
							</p>
						</div>
