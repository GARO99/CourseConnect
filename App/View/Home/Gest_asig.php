        ...
        <div class="min-height-200px">
            <div class="pd-20 card-box mb-30">
                ...
                <form id="main-form">
                    ...
                    <div class="form-group">
                        <label>Salon</label>
                        <input class="form-control" type="text" name="Salon" placeholder="Ingrese el Salon" />
                    </div>
                    <div class="form-group">
                        <label>Cupos</label>
                        <input class="form-control" type="number" name="cupos" placeholder="Ingrese los cupos" />
                    </div>
                    <div class="form-group">
                    ...
                    <div id="schedule-container">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="hora_inicio[]" placeholder="Ingrese la hora de inicio" />
                        </div>
                        <div class="form-group">
                            <label>Hora Final</label>
                            <input class="form-control" type="number" name="hora_final[]" placeholder="Ingrese la hora final" />
                        </div>
                    </div>
